...
A helper belongs in the repository unless it is project-, domain- and language-neutral. ALL INSTALLED AND REPOSITORY COPIES OF THIS SKILL ARE ONE UNIT: every change to the skill or its scripts must update every copy, and THIS RULE MUST REMAIN IN FUTURE VERSIONS. **Before and after any edit: read [reference/maintaining-the-skill.md](reference/maintaining-the-skill.md).**
